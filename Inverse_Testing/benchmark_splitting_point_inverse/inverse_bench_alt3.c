...
//         print_pol(s, "s_upd",NUM_DIGITS_GF2X_ELEMENT+1);
        ...
        /* *********************** update u, v *************************/
        DIGIT  u_h00[2*NUM_DIGITS_GF2X_ELEMENT+1] = {0};
        DIGIT  v_h01[2*NUM_DIGITS_GF2X_ELEMENT+1] = {0};
        DIGIT  u_h10[2*NUM_DIGITS_GF2X_ELEMENT+1] = {0};
        DIGIT  v_h11[2*NUM_DIGITS_GF2X_ELEMENT+1] = {0};
...
//        print_pol(u_h00, "u*h00",2*NUM_DIGITS_GF2X_ELEMENT+1);
//        print_pol(v_h01, "v*h01",2*NUM_DIGITS_GF2X_ELEMENT+1);
//        print_pol(u, "u_upd",2*NUM_DIGITS_GF2X_ELEMENT);

        gf2x_add(2*NUM_DIGITS_GF2X_ELEMENT, v,
                 2*NUM_DIGITS_GF2X_ELEMENT, u_h10+1,
                 2*NUM_DIGITS_GF2X_ELEMENT, v_h11+1);
//        print_pol(u_h10, "u*h10",2*NUM_DIGITS_GF2X_ELEMENT+1);
//        print_pol(v_h11, "v*h11",2*NUM_DIGITS_GF2X_ELEMENT+1);
//        print_pol(v, "v_upd",2*NUM_DIGITS_GF2X_ELEMENT);
     }
 }
 //fprintf(stderr,"done\n");
 // print_pol(u, "u_out",2*NUM_DIGITS_GF2X_ELEMENT);
 // print_pol(v, "v_out",2*NUM_DIGITS_GF2X_ELEMENT);
 if (deg_r == 0) {
